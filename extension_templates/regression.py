"""Extension template for time series regressor.
...
class MyTimeSeriesRegressor(BaseRegressor):
    """Custom time series regressor. todo: write docstring.

    todo: describe your custom time series regressor here
    ...
    _tags = {
        ...
        # packaging info
        # --------------
        "authors": ["geetikavadali"],  # authors, GitHub handles
    ...
    def _fit(self, X, y):
        ...
        Parameters
        ----------
        X : time series to fit the regressor to, of type self.get_tag("X_inner_mtype")
        y : class labels for fitting, of type self.get_tag("y_inner_mtype")
    ...
    def _predict(self, X):
        ...
        Parameters
        ----------
        X : time series to oredict labels for
        ...
        y_pred : np.ndarray of predicted class labels
            should be of mtype in self.get_tag("y_inner_mtype")
            1D iterable, of shape [n_instances]
            or 2D iterable, of shape [n_instances, n_dimensions]
